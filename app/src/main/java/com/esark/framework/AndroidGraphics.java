...
import com.esark.gasp.GetLruCache;
...
public class AndroidGraphics extends AndroidGame implements Graphics {
    ...
    public void drawYellowLine(int x, int y, int x2, int y2, int color) {
    ...
    public void drawMedText(String smallText, int x, int y) {
        paint.setColor(Color.BLACK);
        paint.setTextSize(40);
        canvas.drawText(smallText, x, y, paint);
        return;
    }
